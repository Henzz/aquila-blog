     ...
     ============================================= -->
      ...
      ============================================= -->
            <div class="heading-block center container clearfix">
                <h2></h2>
                <span>Today, creating an attractive web design is of utmost importance. The design of your website will play
                    a vital role in how users will perceive your brand. We offer services and solutions that can put your
                    business on top of the list.</span>
            </div>
            ...
            <div class="container clearfix">
                <div id="side-navigation">
                    ...
                    <div class="col_one_third">
                        ...
                        <ul class="sidenav">
                            <li class="ui-tabs-active"><a href="#snav-content1"><i class="icon-screen"></i>Brand Creation
                                    and Digital Promotion<i class="icon-chevron-right"></i></a></li>
                            <li><a href="#snav-content2"><i class="icon-magic"></i>Design And Development<i
                                        class="icon-chevron-right"></i></a></li>
                            <li><a href="#snav-content3"><i class="icon-tint"></i>Software Project Research and Modeling<i
                                        class="icon-chevron-right"></i></a></li>
                    ...
                    <div class="col_two_third col_last">
                        ...
                        <div id="snav-content1">
                            ...
                            <p>Fully Brand your new system with the latest Graphics Designing Concepts and Softwares. Using
                                the latest trends and digital promotion.</p>
                        </div>

                        <div id="snav-content2">
                            <h3>Design And Development</h3>
                            <p>In Design and Development sector we have a long time experience developing different kinds of
                                System Design and Development.</p>
                        </div>

                        <div class="clearfix" id="snav-content3">
                            <h3>Software Project Research and Modeling</h3>
                            <p>We do researches for software development projects and provide professional documentation
                                that can be used in large project management. We also provide professional consultation on
                    ...
                    <div class="container clearfix">
                        ...
                        <div class="col_one_third">
                            <div class="feature-box fbox-plain">
                                <div class="fbox-icon" data-animate="bounceIn">
                                    <a href="#"><img src="/acss/images/icons/features/responsive.png"
                                            alt="Responsive Layout"></a>
                                </div>
                        ...
                        <div class="col_one_third">
                            <div class="feature-box fbox-plain">
                                ...
                                <p>Looks beautiful &amp; ultra-sharp on Retina Screen Displays. Retina Icons, Fonts &amp;
                                    all other graphics are optimized.</p>
                            </div>
                        </div>
                        ...
                        <div class="col_one_third col_last">
                            <div class="feature-box fbox-plain">
                                <div class="fbox-icon" data-animate="bounceIn" data-delay="400">
                                    <a href="#"><img src="/acss/images/icons/features/performance.png"
                                            alt="Powerful Performance"></a>
                                </div>
                        ...
                        <div class="col_one_third">
                            <div class="feature-box fbox-plain">
                                ...
                                <p>You have complete easy control over each &amp; every element that provides endless
                        ...
                        <div class="col_one_third col_last">
                            <div class="feature-box fbox-plain">
                                <div class="fbox-icon" data-animate="bounceIn" data-delay="1000">
                                    <a href="#"><img src="/acss/images/icons/features/tools.png"
                                            alt="Powerful Performance"></a>
                                </div>
                        ...
                        <div class="col_one_third col_last">
                            <div class="feature-box fbox-plain">
                                <div class="fbox-icon" data-animate="bounceIn" data-delay="1600">
                                    <a href="#"><img src="/acss/images/icons/features/support.png"
                                            alt="Powerful Performance"></a>
                                </div>
                                <h3>Powerful Performance</h3>
                                <p>Canvas includes tons of optimized code that are completely customizable and deliver
