...
<head>
	...
	<!-- Document Title
	============================================= -->
	<title>Portfolio - Security System Supply and Installation</title>
	...
	<div id="wrapper" class="clearfix">
		...
		<section id="page-title">
			...
			<div class="container clearfix">
				<h1>Portfolio - Security System Supply and Installation</h1>
				<ol class="breadcrumb">
		...
		<section id="page-title">
			<div class="container clearfix" style="margin-top: 10px; font-size: 16px;">
				<p>
					<bold>Our CCTV cameras</bold> are designed to detect intrusion – unauthorized entry – into a building or other areas such as an industry or company. These CCTV video camera surveillance systems can cover any or every area of your residential or commercial property and can be viewed in real-time from almost any mobile device.
				</p>
			</div>
		</section>
									...
									<div class="fslider" data-arrows="false" data-speed="400" data-pause="4000">
										<div class="flexslider">
											<div class="slider-wrap">
												<div class="slide"><a href="portfolio-single-gallery.html"><img src="/acss/images/portfolio/1/New_Added/cctv-1.jpg" alt="Nektar"></a></div>
												<div class="slide"><a href="portfolio-single-gallery.html"><img src="/acss/images/portfolio/1/New_Added/cctv-2.jpg" alt="Nektar"></a></div>
											</div>
										</div>
									</div>
									<div class="portfolio-overlay" data-lightbox="gallery">
										<a href="/acss/images/portfolio/1/New_Added/cctv-1.jpg" class="center-icon" data-lightbox="gallery-item"><i class="icon-line-stack-2"></i></a>
										<a href="/acss/images/portfolio/1/New_Added/cctv-2.jpg" class="center-icon" data-lightbox="gallery-item"><i class="icon-line-stack-2"></i></a>
									</div>
								</div>
								<div class="portfolio-desc">
									<h3><a href="#" target="_blank">CCTV Security</a></h3>
									<p>Some of the works we`ll be doing</p>
								</div>
							</article>
