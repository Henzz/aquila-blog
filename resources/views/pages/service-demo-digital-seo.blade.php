...
<head>
    ...
    <!-- Document Title
	============================================= -->
    <title>Digital Marketing & SEO Services</title>
...
<body class="stretched">
    ...
    <div id="wrapper" class="clearfix">
        ...
        <!-- Slider
		============================================= -->
        <section id="slider" class="slider-element slider-parallax full-screen clearfix" style="background: #FFF url('/acss/demos/seo/images/hero/hero-1.jpg') center center no-repeat; background-size: cover;">
        ...
        <section id="content">
            ...
            <div class="content-wrap pt-0">
				...
				============================================= -->
                            ...
                            <div class="row">
                                <div class="col-md-4 mt-5">
                                    <div class="feature-box fbox-center noborder">
                                        <div class="fbox-icon">
                                            <a href="#"><img src="/acss/demos/seo/images/icons/research.svg" alt="Feature Icon" class="nobg noradius"></a>
                                        </div>
                                        <h3 class="nott ls0">1. Planning &amp; Research</h3>
                                        <p style="text-align: left;">It’s important to plan your research flexibly, but having milestones to tick off can help keep on track and focussed. We apply an investigation that uses empirical observations in the development and assessment of plans or planning inquiry.</p>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4 mt-5">
                                    <div class="feature-box fbox-center noborder">
                                        <div class="fbox-icon">
                                            <a href="#"><img src="/acss/demos/seo/images/icons/optimizing.svg" alt="Feature Icon" class="nobg noradius"></a>
                                        </div>
                                        <h3 class="nott ls0">2. Optimizing</h3>
                                        <p style="text-align: left;">Processing and optimizing web pages and their content to be easily discoverable by any users searching for terms relevant to your website. The term SEO also describes the process of making web pages easier for search engine indexing software, known as "crawlers," to find, scan, and index your site.</p>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4 mt-5">
                                    <div class="feature-box fbox-center noborder">
                                        <div class="fbox-icon">
                                            <a href="#"><img src="/acss/demos/seo/images/icons/result.svg" alt="Feature Icon" class="nobg noradius"></a>
                                        </div>
                                        <h3 class="nott ls0">3. Result</h3>
                                        <p style="text-align: left;">Keeping the program informed about the activities and What will the outcomes of the success be.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row justify-content-between align-items-center clearfix" style="margin-bottom: 70px;">

                            <div class="col-lg-4 col-sm-6">

                                <div class="feature-box fbox-right noborder">
                                    <div class="fbox-icon">
                                        <a href="#"><img src="/acss/demos/seo/images/icons/seo.svg" alt="Feature Icon" class="nobg noradius"></a>
                                    </div>
                                    <h3 class="nott ls0">SEO optimization</h3>
                                    <p>Our Search Engine Optimization (SEO) strategies and tactics can increase organic search visibility on Google and assist in leads for your company.</p>
                                </div>

                                <div class="feature-box fbox-right noborder mt-5">
                                    <div class="fbox-icon">
                                        <a href="#"><img src="/acss/demos/seo/images/icons/adword.svg" alt="Feature Icon" class="nobg noradius"></a>
                                    </div>
                                    <h3 class="nott ls0">Adwords Campaign</h3>
                                    <p>Get in front of customers when they’re searching for businesses like yours on Google Search and Maps or any other. Only pay for results, like clicks to your website or calls to your business.</p>
                                </div>

                                <div class="feature-box fbox-right noborder mt-5">
                                    <div class="fbox-icon">
                                        <a href="#"><img src="/acss/demos/seo/images/icons/analysis.svg" alt="Feature Icon" class="nobg noradius"></a>
                                    </div>
                                    <h3 class="nott ls0">Digital Analysis</h3>
                                    <p>Get a positive effect on your overall business efforts. Quantitative results are essential for every business because they help you to learn more about the current status and, of course, helps you to decide which road you should take.</p>
                                </div>

                            </div>

                            <div class="col-lg-3 col-7 offset-3 offset-sm-0 d-sm-none d-lg-block center my-5">
                                <img src="/acss/demos/seo/images/sections/2.png" alt="iphone" class="rounded  parallax" data-bottom-top="transform: translateY(-30px)" data-top-bottom="transform: translateY(30px)">
                            </div>
                            ...
                            <div class="col-lg-4 col-sm-6">
                                ...
                                <div class="feature-box noborder">
                                    <div class="fbox-icon">
                                        <a href="#"><img src="/acss/demos/seo/images/icons/social.svg" alt="Feature Icon" class="nobg noradius"></a>
                                    </div>
                                ...
                                <div class="feature-box noborder mt-5">
                                    <div class="fbox-icon">
                                        <a href="#"><img src="/acss/demos/seo/images/icons/experience.svg" alt="Feature Icon" class="nobg noradius"></a>
                                    </div>
                                    <h3 class="nott ls0">Customer Experience</h3>
                                    <p>Positive customer experience is crucial to the success of your business because a happy customer is one who is likely to become a loyal customer who can help you boost revenue. The best marketing money can buy is a customer who will promote your business for you.</p>
                                </div>

                                <div class="feature-box noborder mt-5">
                                    <div class="fbox-icon">
                                        <a href="#"><img src="/acss/demos/seo/images/icons/content_marketing.svg" alt="Feature Icon" class="nobg noradius"></a>
                                    </div>
                                    <h3 class="nott ls0">Content Marketing</h3>
                                    <p>Content marketing is at the heart of the most successful digital marketing campaigns. Behind every great brand is a wealth of valuable and relevant content that really connects with the company’s audience.</p>
                                </div>
